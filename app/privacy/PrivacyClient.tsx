...
export default function PrivacyClient({ data }: { data: PrivacyData }) {
  const { hero, lastUpdated, sections, consent } = data
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <AnimateInView delay={0.3}>
              <div className="mt-12 rounded-lg border border-border bg-card p-6 md:p-8">
                <h3 className="mb-4 text-xl font-bold text-foreground">{consent.title}</h3>
