...
import { expectations, faqs, meetingTypes } from "../../data/corpus"
                ...
                >
                  <Card className="h-full transition-all hover:shadow-xl">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="mb-6 text-sm text-muted-foreground leading-relaxed">{type.description}</p>
              ...
              <CardContent className="p-8">
                <div className="aspect-video flex items-center justify-center rounded-lg bg-muted">
                  <div className="text-center text-muted-foreground">
                    ...
                    <div>Calendar Integration (Calendly/TidyCal)</div>
                    <div className="mt-4 text-sm">Embed your booking calendar here</div>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="container px-4">
          ...
          >
            ...
            <Button size="lg" asChild>
              <Link href="#calendar">Book My Session Now</Link>
            </Button>
          </motion.div>
        </div>
      </section>
